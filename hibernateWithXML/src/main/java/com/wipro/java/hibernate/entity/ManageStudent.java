...
public class ManageStudent {
	...
	public static void main(String[] args) {
		...
		Integer sID1 = student.addStudent("Mounica", "19HU1A04433", "5thClass");
		Integer sID2 = student.addStudent("Ravi", "19HU1A04434", "5thClass");
		Integer sID3 = student.addStudent("Mani", "19HU1A04435", "5thClass");
		// total Students list
		student.listOfStudents();
		// update particular student data
		student.updateStudent(sID1, "Mounica Kikkara");
